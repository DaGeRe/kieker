...
public class AsciiLogReader extends AbstractProducerStage<IMonitoringRecord> implements IMonitoringRecordReceiver {
	 ...
	 *            Determines whether to decompress the Kieker log files.
	 */
	public AsciiLogReader(final String[] inputDirs, final boolean ignoreUnknownRecordTypes, final boolean shouldDecompress) {
		...
		if (nDirs == 0) {
			this.logger.warn("The list of input dirs passed to the " + AsciiLogReader.class.getSimpleName() + " is empty");
			nDirs = 1;
		}
