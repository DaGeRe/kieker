 ...
 * @since 1.13
 */
class FastFileWriterPool extends WriterPool {
	...
	public FastFileWriterPool(final Log writerLog, final Path folder, final String charsetName, final int maxEntriesInFile, final boolean shouldCompress,
