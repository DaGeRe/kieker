...
public class FastFileWriter extends AbstractMonitoringWriter implements IRegistryListener<String>, IFileWriter {

	public static final String PREFIX = FastFileWriter.class.getName() + ".";
	/**
	...
	private static final Log LOG = LogFactory.getLog(FastFileWriter.class);

	private final Path logFolder;
	private final FastFileWriterPool fileWriterPool;
	...
	public FastFileWriter(final Configuration configuration) {
		super(configuration);
		...
		this.fileWriterPool = new FastFileWriterPool(LOG, this.logFolder, charsetName, maxEntriesPerFile,
